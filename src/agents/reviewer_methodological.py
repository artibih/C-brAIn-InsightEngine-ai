...
from src.prompts.reviewer_methodological_prompt import REVIEWER_METHODOLOGICAL_PROMPT
...
class ReviewerMethodological:
    def __init__(self, llm_selection: ResolvedLlmSelection | None = None):
        ...
        self.prompt = ChatPromptTemplate.from_template(REVIEWER_METHODOLOGICAL_PROMPT)
    ...
    async def review(
        ...
        logger.info(
            "reviewer_methodological_llm_started",
        ...
        try:
            ...
            logger.info(
                "reviewer_methodological_llm_completed",
                experiment_id=experiment_id,
                duration=end - start,
            ...
            logger.exception(
                "reviewer_methodological_llm_failed",
                experiment_id=experiment_id,
                error=str(e),
            )
            ...
            try:
                ...
                if match:
                    ...
                    logger.info(
                        "reviewer_methodological_llm_recovered_partial_json",
                        experiment_id=experiment_id,
                    )
